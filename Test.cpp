...
CHECK_THROWS(notebook_test.write(1,0,3,Direction::Vertical, ""));
...
CHECK_THROWS(notebook_test.erase(2,1,3,Direction::Horizontal, -1));
CHECK_THROWS(notebook_test.erase(9,5,3,Direction::Horizontal, 0));
}
